        ...
        class GraphDrawer
        {
            ...
            public void DrawShutterGraph(float angle)
            {
                ...
                if (Mathf.Approximately(angle, 0f))
                    UnityEngine.GUI.Label(labelRect, "Off", m_MiddleCenterStyle);
                else if (Mathf.Approximately(angle, 360f))
                    UnityEngine.GUI.Label(labelRect, "Full", m_MiddleCenterStyle);
                ...
                UnityEngine.GUI.Label(new Rect(barOrigin, outerBarSize), barText, m_MiddleCenterStyle);
            }
            ...
            public void DrawBlendingGraph(float strength)
            {
                ...
                for (var i = 0; i < 5; i++)
                {
                    ...
                    UnityEngine.GUI.Label(rect, m_BlendingIcon);

                    UnityEngine.GUI.color = Color.white;
                    UnityEngine.GUI.Label(rect, (weight * 100).ToString("0") + "%", m_LowerCenterStyle);
                }
